...
**2026-02-10 00:10:00 -05:00 (America/Guayaquil)**
Sprint: SPR-011
Estado resultante: READY_FOR_VALIDATION
Resumen:
- Presentaciones/empaques por producto/variante
- Lookup incluye barcode de presentación
- UI mínima + smoke script
...
- Comandos ejecutados por el usuario:
  ...
  - `./mvnw spring-boot:run`
  - `cd ..`
  - `pwsh -ExecutionPolicy Bypass -File .\scripts\smoke\sprint11.ps1`
- Output:
```text
PEGAR OUTPUT AQUÍ
```
